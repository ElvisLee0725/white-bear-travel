...
// Import jquery from the NPM package 
			...
			this.itemsToReveal.each(function () {
				...
				new Waypoint({
					...
					handler: function handler() {
						// What to do when seeing the item
...
var StickyHeader = function () {
	...
	// Since we use lazyload, the Waypoint that calculates the distance to load waypoint will be affected. Therefore, we need to refresh Waypoint to calculate again.
